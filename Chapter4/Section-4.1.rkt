...
;--------------------------------------------------------------
;Section 4.1, Exercise 4.1

;See list-of-values procedure below within the evaluator


;--------------------------------------------------------------
;Section 4.1, Exercise 4.3

;See the eval procedure within the evaluator below


;--------------------------------------------------------------
;Section 4.1, Exercise 4.4

;See eval-and and eval-or within the evaluator below

;--------------------------------------------------------------
;Section 4.1, Exercise 4.5

;See the arrow-clause? lines within the eval-cond implementation below


;--------------------------------------------------------------
;Section 4.1, Exercise 4.6

;See let->combination below

;--------------------------------------------------------------
;Section 4.1, Exercise 4.7

;See let*->nested-lets below

;--------------------------------------------------------------
;Section 4.1, Exercise 4.8

;See the named-let handling within let->combination below
...
;--------------------------------------------------------------
;Section 4.1, Exercise 4.9

;See eval-for, eval-while, and eval-until below



;--------------------------------------------------------------
;Section 4.1, Exercise 4.11
;Replace environment code below with the following to use the new environment representation:
...
(define (lists-to-bindings vars vals)
  (define (iter vars vals result)
    (if (null? vars) result
        (iter (cdr vars)
              (cdr vals)
              (cons (make-binding (car vars) (car vals)) result))))
  (iter vars vals '()))


(define (extend-environment vars vals base-env)
  (if (= (length vars) (length vals))
      (cons (make-frame (lists-to-bindings vars vals)) base-env)
      (if (< (length vars) (length vals))
...
;--------------------------------------------------------------
;Section 4.1, Exercise 4.12
;see the definitions of define-variable!, set-variable-value!, and lookup-variable-value below

;--------------------------------------------------------------
;Section 4.1, Exercise 4.13
;See the definition of make-unbound below

;--------------------------------------------------------------
;Section 4.1, Exercise 4.14
;See definitions of lookup-variable-value and scan-out-defines below


;--------------------------------------------------------------
;Section 4.1, Exercise 4.20

;See definition of letrec->let below
...
;--------------------------------------------------------------
;Below find the implementation of the metacircular evaluator,
...
(put 'do eval-do)
(put 'make-unbound! eval-unbinding)
